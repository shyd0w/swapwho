...
/**
 * @ngdoc object
 * @name lbServices.Swapper
 * @header lbServices.Swapper
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Swapper` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__findById__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         * Find a related item by id for accessTokens
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Swapper` object.)
         * </em>
         */
        "prototype$__findById__accessTokens": {
          url: urlBase + "/Swappers/:id/accessTokens/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__destroyById__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__updateById__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__get__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         * Queries accessTokens of Swapper.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__accessTokens": {
          isArray: true,
          url: urlBase + "/Swappers/:id/accessTokens",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__create__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__delete__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$__count__accessTokens
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         * Counts accessTokens of Swapper.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         */
        "prototype$__count__accessTokens": {
          url: urlBase + "/Swappers/:id/accessTokens/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#create
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "create": {
          url: urlBase + "/Swappers",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#upsert
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#exists
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Swappers/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#findById
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Swappers/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#find
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#findOne
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Swappers/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#updateAll
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Swappers/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#deleteById
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Swappers/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#prototype$updateAttributes
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        "login": {
          ...
          url: urlBase + "/Swappers/login",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#logout
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        "logout": {
          ...
          url: urlBase + "/Swappers/logout",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#confirm
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "confirm": {
          url: urlBase + "/Swappers/confirm",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#resetPassword
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         ...
         */
        "resetPassword": {
          url: urlBase + "/Swappers/reset",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Swapper#getCurrent
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#updateOrCreate
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#update
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#destroyById
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#removeById
         * @methodOf lbServices.Swapper
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#getCachedCurrent
         * @methodOf lbServices.Swapper
         *
         * @description
         *
         * Get data of the currently logged user that was returned by the last
         * call to {@link lbServices.Swapper#login} or
         * {@link lbServices.Swapper#getCurrent}. Return null when there
         * is no user logged in or the data of the current user were not fetched
         * yet.
         *
         * @returns {Object} A Swapper instance.
         */
        R.getCachedCurrent = function() {
          var data = LoopBackAuth.currentUserData;
          return data ? new R(data) : null;
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#isAuthenticated
         * @methodOf lbServices.Swapper
         *
         * @returns {boolean} True if the current user is authenticated (logged in).
         */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Swapper#getCurrentId
         * @methodOf lbServices.Swapper
         *
         * @returns {Object} Id of the currently logged-in user or null.
         */
    ...
    /**
    * @ngdoc property
    * @name lbServices.Swapper#modelName
    * @propertyOf lbServices.Swapper
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Swapper`.
    */
